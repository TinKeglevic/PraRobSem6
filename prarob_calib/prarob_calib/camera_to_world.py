...
def generate_world_points_R(checkerboard_dim=checkerboard_dimensions, square_size=0.0186):
    ...
    T_R_checkerboard[1, 3] = -0.3
    T_R_checkerboard[2, 3] = 11.0
...
class CamToWorld(Node):
    ...
    def image_callback(self, data):
        ...
        if ret:
            ...
            ret_pnp, rvecs, tvecs = cv2.solvePnP(
                world_points,
                corners2,
                self.k_matrix,
                self.distortion_params,
            ...
            if ret_pnp:
                ...
                T_cam_world[:3, 3] = tvecs.reshape(3)
                ...
                red_mask = cv2.GaussianBlur(red_mask, (5, 5), 2, 2)
                ...
                if circles is not None:
                    ...
                    for (x, y, r) in circles:
                        ...
                        cv2.circle(rgb_image, (x, y), 2, (255, 0, 0), 3)

                else:
                    self.get_logger().info('No red circle detected')
